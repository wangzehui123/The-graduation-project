...
public class AdminController {
    ...
    public String addStudent(StudentCustom studentCustom, Model model) throws Exception {
        ...
        userlogin.setPassword(md5.toString());
        userlogin.setRole(2);
    ...
    public String addCourse(CourseCustom courseCustom, Model model) throws Exception {
        ...
        String result = courseService.save(courseCustom);
    ...
    public String removeCourse(Integer id,Model model) throws Exception {
        ...
        Boolean aBoolean = courseService.removeById(id);
        if (aBoolean){
            return "redirect:/admin/showCourse";
        }else {
            model.addAttribute("message", "此课程正在修读，不可删除");
            return "error";
        }
    }
...
//              u.setPassword(userlogin.getPassword());
            Md5Hash md5 = new Md5Hash(userlogin.getPassword());
