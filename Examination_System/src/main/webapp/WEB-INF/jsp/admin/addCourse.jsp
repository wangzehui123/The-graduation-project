				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/admin/addCourse" id="editfrom" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select class="form-control" name="coursetime" placeholder="请选择上课时间">
									<option value="周一1-2节">周一1-2节</option>
									<option value="周一3-4节">周一3-4节</option>
									<option value="周一5-6节">周一5-6节</option>
									<option value="周一7-8节">周一7-8节</option>
									<option value="周二1-2节">周二1-2节</option>
									<option value="周二3-4节">周二3-4节</option>
									<option value="周二5-6节">周二5-6节</option>
									<option value="周二7-8节">周二7-8节</option>
									<option value="周三1-2节">周三1-2节</option>
									<option value="周三3-4节">周三3-4节</option>
									<option value="周三5-6节">周三5-6节</option>
									<option value="周三7-8节">周三7-8节</option>
									<option value="周四1-2节">周四1-2节</option>
									<option value="周四3-4节">周四3-4节</option>
									<option value="周四5-6节">周四5-6节</option>
									<option value="周四7-8节">周四7-8节</option>
									<option value="周五1-2节">周五1-2节</option>
									<option value="周五3-4节">周五3-4节</option>
									<option value="周五5-6节">周五5-6节</option>
									<option value="周五7-8节">周五7-8节</option>
								</select>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" class="form-control" name="courseweek" id="courseweek" placeholder="请输入周数">
							</div>
						</div>
						<div class="form-group">
...
<script type="text/javascript">
	...
	$("form").submit(function () {
		let courseid = $("#inputEmail3").val();
		let name = $("#inputPassword3").val();
		let classroom = $("#classroom").val();
		let courseweek = $("#courseweek").val();
		if (courseid == ""){
			alert("请输入课程号");
			return false;
		}
