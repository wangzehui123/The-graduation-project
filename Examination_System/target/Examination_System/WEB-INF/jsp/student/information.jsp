...
<body>
<!-- 顶栏 -->
<jsp:include page="../student/top.jsp"></jsp:include>
<!-- 中间主体 -->
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form"  id="editfrom" >
                        ...
                        <div class="form-group" style="text-align: center">
                            <button class="btn btn-default" type="button" id="fromSubmit">提交</button>
...
<script type="text/javascript">
    ...
    $("#fromSubmit").click(function () {
        ...
        $.ajax({
            type: "post",   //提交的方法
            url:"${pageContext.request.contextPath}/student/editInformation", //提交的地址
            data:$('#editfrom').serialize(),// 序列化表单值
            async: false,
