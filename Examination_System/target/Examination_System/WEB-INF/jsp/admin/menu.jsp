...
<div class="col-md-2">
    <ul class="nav nav-pills nav-stacked" id="nav">
        <li><a href="${pageContext.request.contextPath}/admin/showCourse">课程管理<span class="glyphicon glyphicon-book pull-right"></span></a></li>
        ...
        <li><a href="${pageContext.request.contextPath}/admin/showTeacher">教师管理<span class="glyphicon glyphicon-user pull-right"></span></a></li>
